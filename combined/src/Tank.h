...
public:
	...
	Tank();
	Tank(b2World& world, b2FixtureDef& chasisdef, b2FixtureDef& wheeldef, float x, float y,  std::string body_text,  std::string top_text,bool flip);
	void setup(b2World& world, b2FixtureDef& chasisdef, b2FixtureDef& wheeldef, float x, float y,  std::string body_text,  std::string top_text,bool flip);
